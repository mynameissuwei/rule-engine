<template>
  <el-container>
    ...
    <el-main>
      <el-form :rules="rules" label-position="right" label-width="130px" :model="ruleLayoutForm">
        <el-form-item label="规则编排名称：" prop="name">
          <el-input style="width: 400px;height: 30px;" v-model="ruleLayoutForm.name"></el-input>
        </el-form-item>
        <el-form-item label="规则编排代码：" prop="code">
          <el-input style="width: 400px;height: 30px;" v-model="ruleLayoutForm.code"></el-input>
        ...
        <el-form-item label="使用场景描述：">
          <el-input v-model="ruleLayoutForm.sceneDesc" style="width: 400px;height: 30px" :disabled="scene === 'preview'"></el-input>
        </el-form-item>
