<template>
  <div>
    <rule-header :leftText="id ? '编辑校验规则' : '新建校验规则'" :showButton="id ? true : false" />
    <div class="container">
      <div class="form-box">
        <el-form ref="formRef" :rules="rules" :model="form" label-width="120px">
          <el-form-item label="规则名称:" prop="name">
            <el-input v-model="form.ruleName" placeholder="可使用中英文、数字组合"></el-input>
            <el-tooltip class="item" content="支持中英文、数字组合" effect="light" placement="top">
              <el-icon><question-filled /></el-icon>
            </el-tooltip>
          </el-form-item>
          <el-form-item label="使用场景描述:" prop="region">
            <el-input v-model="form.scenarioName" placeholder="请输入"></el-input>
          </el-form-item>
          <el-form-item label="规则编辑" prop="region">
            <div>
              <div type="primary" size="small" @click="handleCreate" class="gray-button">+ 添加规则</div>
    ...
    <el-footer class="footerContainer">
      <el-button-group>
        ...
        <el-button class="center" size="small" style="margin: 0px 20px" @click="onCancel">取消</el-button>
